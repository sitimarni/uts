    ...
    public static void main(String[] args) throws Exception{
        ...
        do {
            ...
            if (jenisZakat.equalsIgnoreCase("fitrah")) {
                ...
                ZakatFitri zakatFitri = new ZakatFitri(nama, alamat, jenisZakat, jumlahBeras, jumlahZakat);
                zakatList.add(zakatFitri);
            } else if (jenisZakat.equalsIgnoreCase("sedekah")) {
                double jumlahZakat = jumlahUang;

                ZakatFitri zakatFitri = new ZakatFitri(nama, alamat, jenisZakat, jumlahUang, jumlahZakat);
                zakatList.add(zakatFitri);
            }
        ...
        for (ZakatFitri zakat : zakatList) {
